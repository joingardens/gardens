...
function ParagraphWithButton(props) {
  return (
      ...
      <div className="container px-5 py-24 mx-auto flex flex-wrap">
        ...
        <div className="md:w-3/5 md:pl-6">
          ...
          <div className="flex md:mt-4 mt-6">
            <button className={`inline-flex text-white bg-accents-0 border-0 py-1 px-4 focus:outline-none hover:bg-accents-1 rounded`}>
              Button
            </button>
            <a href="" className={`text-secondary inline-flex items-center ml-4`}>
              Learn More
              <svg
                fill="none"
                stroke="currentColor"
...
ParagraphWithButton.defaultProps = {
  theme: 'indigo'
};

ParagraphWithButton.propTypes = {
